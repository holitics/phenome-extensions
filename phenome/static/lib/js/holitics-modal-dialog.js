// holitics-modal-dialog.js
// Copyright (c) 2019 Nicholas Saparoff, Phenome Project
//
// Modal dialog functions for Holitics API

var modal_settings = {};
var last_modal_id = null;

function _launch_modal_dialog(title, modal_id, content, button_text, button_click, hide_footer) {
	...
	modal.find('.modal-dialog').maxWidth='60%';
